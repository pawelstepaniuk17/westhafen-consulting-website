          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <Mail size={20} className="text-[#c9a35e] mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Phone size={20} className="text-[#c9a35e] mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Clock size={20} className="text-[#c9a35e] mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <MapPin size={20} className="text-[#c9a35e] mt-1 flex-shrink-0" />
                <div>
