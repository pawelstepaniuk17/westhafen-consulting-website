        ...
        <div className="cookie-content space-y-12">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-neutral-400 space-y-2 mb-4 ml-4">
              <li><strong>Google Analytics:</strong> We use Google Analytics to understand how visitors use our Website. Google may use the collected data to contextualize and personalize ads across its advertising network. You can learn more about Google&apos;s privacy practices at <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#c9a35e] hover:underline">policies.google.com/privacy</a>.</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-neutral-400 space-y-2 mb-4 ml-4">
              <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-[#c9a35e] hover:underline">Google Chrome</a></li>
              <li><a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noopener noreferrer" className="text-[#c9a35e] hover:underline">Mozilla Firefox</a></li>
              <li><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-[#c9a35e] hover:underline">Apple Safari</a></li>
              <li><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-[#c9a35e] hover:underline">Microsoft Edge</a></li>
            </ul>
            <h3 className="font-serif text-lg mb-3 mt-6">6.2 Opt-Out Tools</h3>
            <p className="text-neutral-400 leading-relaxed mb-4">
              You can opt out of Google Analytics by installing the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#c9a35e] hover:underline">Google Analytics Opt-out Browser Add-on</a>.
            </p>
